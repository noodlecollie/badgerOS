...
#else
#include <SSD1351/SampleDriver/OLED_Driver.h>
#include <SSD1351/SampleDriver/OLED_GFX.h>
#endif
...
void setup()
{
	...
	config.chipSelectPin = oled_cs;
	config.clockPin = oled_sck;
	config.dataCommandPin = oled_dc;
	config.dataInPin = oled_din;
	config.resetPin = oled_rst;
