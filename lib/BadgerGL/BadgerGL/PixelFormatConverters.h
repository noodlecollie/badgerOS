...
namespace BadgerGL
{
	struct PixelFormatConverter
	{
		...
		{
			return destType == expectedDestType && canConvert && convert;
		}
		...
		bool (*convert)(BitmapBuffer& destBuffer, const ConstBitmapBuffer& sourceBuffer);
		...
		bool (*convertViaPalette)(BitmapBuffer& destBuffer, const ConstBitmapBuffer& sourceBuffer, const ConstBitmapBuffer& palette);
	};
